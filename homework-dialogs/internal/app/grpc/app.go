...
import (
	"context"
	"fmt"
	ars "homework-dialogs/internal/services/auth"
...
func New(log *slog.Logger, grpcDialogs dialog.GrpcDialog, port uint, ars *ars.AuthRemoteService) *App {
	...
	dialog.Register(gRPCServer, grpcDialogs, ars)
